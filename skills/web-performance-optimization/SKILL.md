...
description: "Optimize website and web application performance including loading speed, Core Web Vitals, bundle size, caching strategies, and runtime performance Triggers: web, performance, optimization, web-performance-optimization."
risk: unknown
source: community
